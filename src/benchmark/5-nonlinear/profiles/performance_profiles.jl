...
with_theme(theme_latexfonts()) do
    ...
    stairs!(αs, ρaαs[1, :]; label = "RDFO")
    stairs!(αs, ρaαs[2, :]; label = "MADS-PIP")
    axislegend(position = :rb; labelsize = 20)
    CairoMakie.save("/home/sblelong/msc-thesis/thesis/figures/num-nonlinear-performance-profile-$(τ)-1e-6.pdf", fig; px_per_unit = 4)
end
