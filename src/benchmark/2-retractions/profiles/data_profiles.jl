...
data_dict = Dict(
    "OneOverSpectral" => Vector{Float64}[],
    "OneOverSqrtSpectral" => Vector{Float64}[],
    "NOverSpectral" => Vector{Float64}[],
    "NOverSqrtSpectral" => Vector{Float64}[],
    "Exp" => Vector{Float64}[]
)

base_data_path = "/home/sblelong/.julia/dev/ConstrainedDFO/src/benchmark/2-retractions/data/"
